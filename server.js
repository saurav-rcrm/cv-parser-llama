...
5. Generate additional relevant skills inspired by the work experience, education, certification, any other details from the resume in "skills".
...
Output the result strictly in JSON format as stated above without any additional text, comments, markdown symbols, or stray characters.
`;
